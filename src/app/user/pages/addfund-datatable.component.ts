...
import { IDatatable } from 'src/app/interface/addfund.interface';
import { AddfundService as DatatableService } from 'src/app/service/addfund.service';

@Component({
    selector: 'addfund-datatable-component',
    standalone: true,
            ...
            <div class="table-container">
                ...
                >
                    ...
                    <ng-container matColumnDef="bank_ac">
                        <th mat-header-cell *matHeaderCellDef>My A/C</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.bank_ac }}
                        </td>
                    </ng-container>
                    ...
                    <ng-container matColumnDef="trxid">
                        <th mat-header-cell *matHeaderCellDef>Trxid</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.trxid }}
                        </td>
                    </ng-container>

                    <ng-container matColumnDef="status__name">
                        <th mat-header-cell *matHeaderCellDef>Status</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.status__name }}
                        </td>
                    </ng-container>
...
export class AddfundDatatableComponent implements OnInit, OnDestroy {
