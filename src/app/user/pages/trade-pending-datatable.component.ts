...
import { IPendingDatatable } from 'src/app/interface/trade.interface';
import { TradeService } from 'src/app/service/trade.service';

@Component({
    selector: 'trade-pending-datatable-component',
    standalone: true,
...
export class TradePendingDatatableComponent implements OnInit, OnDestroy {
    displayedColumns: string[] = ['id', 'amount', 'direction', 'created_date'];
    dataSource: any = new MatTableDataSource<IPendingDatatable>();
    selection = new SelectionModel<IPendingDatatable>(true, []);

    datatableData: IPendingDatatable[] = [];
