...
import { ISendDatatable } from 'src/app/interface/transaction.interface';

@Component({
    selector: 'send-datatable-component',
    standalone: true,
    ...
    template: `
        ...
        <div class="container mat-elevation-z8">
            ...
            <div class="table-top-container">
                <div>
                    <div class="table-title">Send Report</div>
                </div>
                <div>
            ...
            <div class="table-container">
                ...
                >
                    ...
                    <ng-container matColumnDef="sender_wallet__name">
                        <th mat-header-cell *matHeaderCellDef>Wallet</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.sender_wallet__name }}
                        </td>
                    </ng-container>

                    <ng-container matColumnDef="receiver__user_name">
                        <th mat-header-cell *matHeaderCellDef>User</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.receiver__user_name }}
                        </td>
                    </ng-container>
...
export class SendDatatableComponent implements OnInit, OnDestroy {
    ...
    dataSource: any = new MatTableDataSource<ISendDatatable>();
    selection = new SelectionModel<ISendDatatable>(true, []);

    datatableData: ISendDatatable[] = [];
