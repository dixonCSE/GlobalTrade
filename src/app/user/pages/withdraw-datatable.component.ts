...
import { IDatatable } from 'src/app/interface/withdraw.interface';

@Component({
    selector: 'withdraw-datatable-component',
    standalone: true,
...
export class WithdrawDatatableComponent implements OnInit, OnDestroy {
