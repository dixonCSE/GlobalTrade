...
import { IReceiveDatatable } from 'src/app/interface/transaction.interface';

@Component({
    selector: 'receive-datatable-component',
    standalone: true,
    ...
    template: `
        ...
        <div class="container mat-elevation-z8">
            ...
            <div class="table-top-container">
                <div>
                    <div class="table-title">Receive Report</div>
                </div>
                <div>
            ...
            <div class="table-container">
                ...
                >
                    ...
                    <ng-container matColumnDef="receiver_wallet__name">
                        <th mat-header-cell *matHeaderCellDef>Wallet</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.receiver_wallet__name }}
                        </td>
                    </ng-container>

                    <ng-container matColumnDef="sender__user_name">
                        <th mat-header-cell *matHeaderCellDef>User</th>
                        <td mat-cell *matCellDef="let element">
                            {{ element.sender__user_name }}
                        </td>
                    </ng-container>
...
export class ReceiveDatatableComponent implements OnInit, OnDestroy {
    displayedColumns: string[] = [
        'id',
        'receive_amount',
        'receiver_wallet__name',
        'sender__user_name',
        'created_date',
    ];

    dataSource: any = new MatTableDataSource<IReceiveDatatable>();
    selection = new SelectionModel<IReceiveDatatable>(true, []);

    datatableData: IReceiveDatatable[] = [];
